...
const BurgerButton = () => {
  ...
  return (
    <>
      ...
      >
        <svg width="3 rem" height="3rem" viewBox="0 0 100 100">
          <path
            class="line line1"
      ...
      <div className={`menu ${toggle ? "" : " slide-in"}`}>
        ...
        <div className="mt-4 pl-2 grid grid-col-4 border-b pb-3 border-black">
          <i class="fa-regular fa-location-pin flex col-start-1 col-span-1"></i>
        ...
        <div className="mt-4 pl-2 grid grid-col-4 pb-3 border-b border-black">
          <i class="fa-regular fa-envelope flex col-start-1 col-span-1"></i>
            <div className="col-start-2 col-span-3">
                <div className="text-sm">info@manero.se</div>
            </div>
        </div>
        <div className="mt-4 pl-2 grid grid-col-4 pb-3 border-b border-black">
          <i class="fa-regular fa-phone flex col-start-1 col-span-1"></i>
            <div className="col-start-2 col-span-3">
